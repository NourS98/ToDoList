...
public class ToDoItem {
	...
	static void packageIntent(Intent intent, String title,
			Priority priority, Status status, String date ,int positionIndicator) {
		...
		intent.putExtra("POSITION", positionIndicator);
	}
